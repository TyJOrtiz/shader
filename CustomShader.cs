...
/// </summary>
namespace Mustastic.Shaders
{
    [AutoConstructor]

    [EmbeddedBytecode(DispatchAxis.XY)]

    public partial struct MyCustomFourColorGradient : IPixelShader<float4>
    {
        /// <summary>
        /// The current time since the start of the application.
        /// </summary>
        public float time;
        //private float3 colorOne;
        //private float3 colorTwo;
        //private float3 colorThree;
        //private float3 colorFour;
        //private float totalSeconds;

        // Colors to blend together
        public float3 colorOne = new(0.999f, 0.999f, 0.999f);
        public float3 colorTwo = new(0.999f, 0f, 0f);
        public float3 colorThree = new(0f, 0.999f, 0f);
        public float3 colorFour = new(0f, 0f, 0.999f);
        private float totalSeconds;

        public MyCustomFourColorGradient(float totalSeconds) : this()
        {
            this.totalSeconds = totalSeconds;
            this.time = totalSeconds;
            this.colorOne = App.ApplicationViewModel.color1;
            this.colorTwo = App.ApplicationViewModel.color2;
            this.colorThree = App.ApplicationViewModel.color3;
